...
export const STEPS: StepData[] = [
    ...
    questions: [
      ...
      },
      {
        ...
        deepProcess: [
          ...
          { label: 'P (연결)', description: '일이나 다른 활동에서도 그 강점 쓴 적 있어?' },
        ],
        tip: { label: '💡 막히면', text: '"다른 사람은 힘들어하는데 너는 자연스럽게 됐던 게 있어?"' },
      },
    ],
  },
  {
    ...
    questions: [
      {
        title: '질문 2-1',
        text: '"지금 어떤 일, 어떤 방향으로 가고 싶어? 그쪽으로 가고 싶은 이유가 뭐야?"',
        deepProcess: [
          { label: 'D (묘사)', description: '목표하는 직무나 분야가 구체적으로 뭐야?' },
          { label: 'E (감정)', description: '그 방향 생각하면 어떤 기분이야? → 뭐가 끌려?' },
          { label: 'E (의미)', description: '그 일에서 네게 정말 중요한 게 뭐야?' },
          { label: 'P (연결)', description: '그 가치가 지금 상황에서도 여전히 중요해?' },
        ],
        tip: { label: '💡 막히면', text: '"지금까지 해온 일이나 경험 중에 가장 보람 있었던 게 뭐야?"' },
      },
      {
        title: '질문 2-2',
        text: '"지금 취업(또는 이직)을 준비하면서 가장 막막하거나 어려운 부분이 뭐야?"',
        deepProcess: [
          { label: 'D (묘사)', description: '막막하다는 게 구체적으로 어떤 상황이야?' },
          { label: 'E (감정)', description: '그럴 때 어떤 기분? → 뭐가 불안해/답답해?' },
          { label: 'E (의미)', description: '제약이 없다면 지금 당장 뭘 하고 싶어?' },
          { label: 'P (연결)', description: '결국 지금 네게 가장 필요한 게 뭔 것 같아?' },
        ],
  ...
  },
  {
    ...
    questions: [
      ...
      {
        title: '질문 3-2',
        text: '"그 미래의 너는 어떤 일을 하고 있고, 누구에게 어떤 가치를 주고 있어?"',
        deepProcess: [
          { label: 'D (묘사)', description: '어떤 일을 하고 있어? 어떤 조직/환경이야?' },
          { label: 'E (감정)', description: '그 일 할 때 어떤 기분일 것 같아?' },
          { label: 'E (의미)', description: '왜 그 일, 그 사람들이 중요해?' },
